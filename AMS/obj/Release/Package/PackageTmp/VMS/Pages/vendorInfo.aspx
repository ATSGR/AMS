...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form class="form-horizontal cmxform commentForm" id="vendorfrom" runat="server" style="overflow: hidden;">

        <p class="heading" style="margin-top: 10px; font-size: 16px;">Vendor Information</p>
        ...
        <div style="border: 1px solid rgb(204, 204, 204); background-color: rgb(245, 245, 245); margin-left: 15px; margin-right: 15px;">
            ...
            <div class="form-group">
                ...
                <div class="col-md-4" style="margin-left: 203px; margin-top: 15px; padding-bottom: 26px;">
